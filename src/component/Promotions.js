                                        ...
                                        <div className="Promotions_box">
                                            <div className="row">
                                                ...
                                                <div className="col-8">
                                                    ...
                                                    <h6>Buy any 2 Restylane Fillers & Save 25% on a 3rd.</h6>
                                                    <div className="row">
                                                        <div className="col">
                                    ...
                                    <div className="col">
                                        <div className="Promotions_box">
                                            <div className="row">
                                                ...
                                                <div className="col-8">
                                                    <h5>MICRONEEDLING</h5>
                                                    <h6>Save $50 When You Buy a Series<br/> of 3 Treatments</h6>
                                                    <div className="row">
                                                        <div className="col">
                                                            <Button variant="light" className="buy_now_btn">Buy Now</Button>{' '}
                                                        </div>
                                    ...
                                    <div className="col">
                                        <div className="Promotions_box">
                                            <div className="row">
                                                ...
                                                <div className="col-8">
                                                    <h5>LIPS & LINES</h5>
                                                    <h6>Get 10 units of Jeuveau FREE with<br/> any Lip Filler Treatment</h6>
                                                    <div className="row">
                                                        <div className="col">
                                                            <Button variant="light" className="buy_now_btn">Buy Now</Button>{' '}
                                                        </div>
