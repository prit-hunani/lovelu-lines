                        ...
                        <div className="slider_in_butn_list">
                            <Carousel responsive={responsives}>
                                <Nav variant="pills" className="flex-column">
                                    <Nav.Item>
                                        <Nav.Link eventKey="first">Wrinkle Relaxers (Jeuveau, Dysport, Botox)</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                                <Nav variant="pills" className="flex-column">   
                                    <Nav.Item>
                                        <Nav.Link eventKey="second">Injectables (Face & Body)</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                                <Nav variant="pills" className="flex-column">      
                                    <Nav.Item>
                                        <Nav.Link eventKey="three">Wrinkle Relaxers plus Filler</Nav.Link>
                                    </Nav.Item>
                                </Nav>   
                                <Nav variant="pills" className="flex-column">      
                                    <Nav.Item>
                                ...
                                <Nav variant="pills" className="flex-column">      
                                    <Nav.Item>
                                        <Nav.Link eventKey="five">Coolsculpting (Call or Chat Online to Book)</Nav.Link>
                                    </Nav.Item>
                                </Nav>  
                                <Nav variant="pills" className="flex-column">      
                                    <Nav.Item>
                                        <Nav.Link eventKey="six">Spa / Aesthetician Services</Nav.Link>
                                    </Nav.Item>
                                </Nav>   
                            </Carousel>      
