                    ...
                    <div className="col-9 only_winfo">
                        <div className="productlists booking_info_right">
                                ...
                                <div className="row thrd_boxes">
                                    ...
                                    <div className="col" style={{background: "#68c9cc2e"}} >
                                        <div className="provider_name_info">
                                            ...
                                            <div className="provider">
                                                <h6>Anastasia is a board certified Family Nurse Practitioner and Nashville native. She received her Bachelor’s Degr...<Link to="" style={{color: "#68C9CC"}}>Read more</Link>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="provider_name_info">
                                            <div className="provider_icon_name">
                                                <div className="provider_fcs">
                                                <img src={amberbakertwo} className="sitlogo" alt="sitelogo"  width="60px" />
                                                </div>
                                                <div className="provider_dp">
                                            ...
                                            <div className="provider">
                                                <h6>Sarah is a board certified Family Nurse Practitioner and Nashville native. She received her Bachelor’s Degr... <Link to="" style={{color: "#68C9CC"}}>Read more</Link>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row thrd_boxes">
                                    <div className="col">
                                        <div className="provider_name_info">
                                            <div className="provider_icon_name">
                                                <div className="provider_fcs">
                                                <img src={amberbakerthred} className="sitlogo" alt="sitelogo"  width="60px" />
                                                </div>
                                                <div className="provider_dp">
                                            ...
                                            <div className="provider">
                                                <h6>Veronica is a board certified Family Nurse Practitioner and Nashville native. She received her Bachelor’s Degr...<Link to="" style={{color: "#68C9CC"}}>Read more</Link>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="provider_name_info">
                                            <div className="provider_icon_name">
                                                <div className="provider_fcs">
                                                <img src={amberbakerfourdth} className="sitlogo" alt="sitelogo"  width="60px" />
                                                </div>
                                                <div className="provider_dp">
                                            ...
                                            <div className="provider">
                                                <h6>Daniel is a board certified Family Nurse Practitioner and Nashville native. He received his Bachelor’s Degr... <Link to="" style={{color: "#68C9CC"}}>Read more</Link>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="provider_name_info">
                                            <div className="provider_icon_name">
                                                <div className="provider_fcs">
                                                <img src={amberbakerfive} className="sitlogo" alt="sitelogo"  width="60px" />
                                                </div>
                                                <div className="provider_dp">
                                            ...
                                            <div className="provider">
                                                <h6>Martin is a board certified Family Nurse Practitioner and Nashville native. He received his Bachelor’s Degr... <Link to="" style={{color: "#68C9CC"}}>Read more</Link>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="priview_next">
                                <div className="row">
                                    <div className="col">
                                        <Link class="buttons_sites_all" to="/booking-system-setup-two">&#8249; &nbsp; Previous</Link>
                                    </div>
                                    <div className="col butn_end">
                                        <Link class="buttons_sites_all" to="/booking-system-setup-four">Next &nbsp; &#8250;</Link>
                                    </div>
                                </div>
                            </div>
                        </div>    
