    ...
    return (
      ...
      >
        <Modal.Body>
          ...
          <p>
          This service requires a desposit of $1.00 to book.
           Your deposit will be applied at the time of treatment.
            Please click continue to proceed.
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button onClick={props.onHide} className="buttons_sites_all">Continue</Button>
        </Modal.Footer>
      </Modal>
    );
  }
                        ...
                        <div className="productlists booking_info_right">
                            ...
                            <div className="Promotions_infoboxs">
                                ...
                                <div className="row tow_buttones">
                                    <div className="col-4">
                                        <Link variant="outline-primary" className="choicsbtn" to="/booking-inperson">In Person</Link>{' '}
                                    </div>
                                    <div className="col-4">
                                        <Link variant="outline-primary" className="choicsbtn" to="/booking-system-setup-thrd">Virtual</Link>{' '}
                                    </div>
                                    <div className="col-4">
                                    </div>
                                </div>
                                ...
                                <div className="row thrd_boxes">
                                    <div className="col">
                                        <div className="provider_name_info" onClick={() => setModalShow(true)}>
                            ...
                            <div className="priview_next">
                                <div className="row">
                                    <div className="col">
                                        <Link class="buttons_sites_all" to="/booking-system-setup-one">&#8249; &nbsp; Previous</Link>
                                    </div>
                                    <div className="col butn_end">
                                        <Link class="buttons_sites_all" to="/booking-system-setup-thrd">Next &nbsp; &#8250;</Link>
                                    </div>
                                </div>
                            </div>
                        </div>    
