                  ...
                  <div className="review_boxs">
                    ...
                    <div className="reting_stars">
                      <div className="star_line">
                        ...
                        <div className="reting_point">5.0 &#8520;</div>
                      </div>
                    </div>
                    <div className="viridied_com">VERIFIED COMPANY</div>
                  </div>
                  <div className="review_boxs">
                    <h3 className="star_hadding">
                      <IoStar /> Trustpilot
