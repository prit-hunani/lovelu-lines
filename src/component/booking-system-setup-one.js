            ...
            <div className="productlists booking_info_right">
              ...
              <div className="Promotions_infoboxs">
                ...
                <Form>
                  ...
                  <h6 style={{ color: "#000" }}>
                    Your name, email, and phone number will be used to send you
                    appointment confirmations and reminders. We’ll also be able
                    to call or text you if anything changes.
                  </h6>
                  <Row>
                    <Col></Col>
                    <Col className="next_button">
                      <Link
                        to="/booking-system-verify"
                        className="book_appint_ment"
                      >
                        Book an Appointment
                      </Link>
                    </Col>
